...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Wish', fields ['profile', 'movie']
        db.create_unique('wishlist', ['profile_id', 'movie_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Wish', fields ['profile', 'movie']
        db.delete_unique('wishlist', ['profile_id', 'movie_id'])
    ...
    models = {
        ...
        u'wishlist.wish': {
            'Meta': {'unique_together': "(('movie', 'profile'),)", 'object_name': 'Wish', 'db_table': "'wishlist'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'movie': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wishes'", 'to': u"orm['movies.Movie']"}),
