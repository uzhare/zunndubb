...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Profile', fields ['identifier']
        db.create_unique('profiles', ['identifier'])


    def backwards(self, orm):
        # Removing unique constraint on 'Profile', fields ['identifier']
        db.delete_unique('profiles', ['identifier'])
