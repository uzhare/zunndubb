...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles', 'avatar',
                      self.gf('django.db.models.fields.files.ImageField')(default='avatars/default.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.avatar'
        db.delete_column('profiles', 'avatar')
