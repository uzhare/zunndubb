...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Profile', fields ['username']
        db.create_unique('profiles', ['username'])


    def backwards(self, orm):
        # Removing unique constraint on 'Profile', fields ['username']
        db.delete_unique('profiles', ['username'])
